...
class ParentWindow(Frame):
    ...
    def sourceDir(self):
        ...
        #this allows the path to be inserted in to the Entry widget properly.
    ...
    def transferFiles(self):
        ...
        #
        #Sets timedelta to 24 hours
        t1 = timedelta(hours=24)
        #Runs through each file in the source directory
        for i in source_files:
            #
            #Retrieves time float from file in designated path
            mt = os.path.getmtime(source + '/' + i)
            #
            #Converts time float type to datetime type
            modTime = datetime.datetime.fromtimestamp(mt)
            #
            #Aged var is equal to current datetime minus the timedelta of 24 hours
            #this is is a date time type
            aged = curTime - t1
            #
